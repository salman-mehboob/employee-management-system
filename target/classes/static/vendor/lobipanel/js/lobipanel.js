...
//            css['position'] = 'absolute';
		...
		$.fn.lobiPanel.DEFAULTS = {
				...
				unpin: {
						icon: 'icon-pin', //You can user glyphicons if you do not want to use font-awesome
						tooltip: 'Unpin'               //tooltip text, If you want to disable tooltip, set it to false
				},
				reload: {
						icon: 'icon-refresh-cw', //You can user glyphicons if you do not want to use font-awesome
						tooltip: 'Reload'           //tooltip text, If you want to disable tooltip, set it to false
				},
				minimize: {
						icon: 'icon-minus-square', //icon is shown when panel is not minimized
						icon2: 'icon-plus-square', //icon2 is shown when panel is minimized
						tooltip: 'Minimize'         //tooltip text, If you want to disable tooltip, set it to false
				},
				expand: {
						icon: 'icon-resize-full-screen', //icon is shown when panel is not on full screen
						icon2: 'icon-resize-100', //icon2 is shown when pane is on full screen state
						tooltip: 'Fullscreen'       //tooltip text, If you want to disable tooltip, set it to false
				},
				close: {
						icon: 'icon-highlight_off', //You can user glyphicons if you do not want to use font-awesome
